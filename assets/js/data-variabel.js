...
export const dbVariabel = [
    {
        ...
        levels: [
            "Tingkat I: Penentuan kegiatan yang diprioritaskan dalam dokumen perencanaan tahunan (Renja/RKPD) dilakukan tanpa ada kriteria yang terukur. [cite: 10]",
            "Tingkat II: Penentuan kegiatan yang diprioritaskan dalam dokumen rencana tahunan dilakukan berdasarkan analisis terhadap hasil (outcome) apa yang akan dicapai kegiatan tersebut. [cite: 10]",
    ...
    {
        id: 2,
        judul: "II. Monitoring dan Pengendalian Pelaksanaan Tugas Perangkat Daerah",
        levels: [
            "Tingkat I: Monitoring dan pengendalian dilakukan dengan cara sederhana dan tidak terstruktur. [cite: 12]",
            "Tingkat II: Monitoring dan pengendalian dilakukan secara berkala dengan fokus yang ditentukan. [cite: 12]",
    ...
    {
        id: 3,
        judul: "III. Penjaminan Mutu Layanan Perangkat Daerah",
        levels: [
            "Tingkat I: Tidak ada penjaminan mutu atas produk yang dihasilkan dan atas proses kerja yang dilakukan. [cite: 14]",
            "Tingkat II: Penjaminan mutu produk dan proses kerja dilakukan secara berkala namun tidak mempunyai standar mutu produk dan proses yang ditetapkan. [cite: 15]",
    ...
    {
        id: 4,
        judul: "IV. Standar Operasional Prosedur (SOP) Pelayanan Perangkat Daerah",
        levels: [
            "Tingkat I: Tidak ada definisi resmi proses pelaksanaan pekerjaan pada perangkat daerah. [cite: 16]",
            "Tingkat II: Definisi proses organisasi sudah dituangkan dalam standar operasi prosedur (SOP). [cite: 17]",
    ...
    {
        id: 5,
        judul: "V. Pendidikan dan Pelatihan Aparatur",
        levels: [
            "Tingkat I: Belum ada dokumen resmi rencana kebutuhan pendidikan dan pelatihan pada perangkat daerah yang bersangkutan. [cite: 22]",
            "Tingkat II: Dokumen rencana kebutuhan pengembangan pegawai sudah tersusun secara parsial untuk jabatan tertentu. [cite: 23]",
    ...
    {
        id: 6,
        judul: "VI. Analisis Kebijakan dan Pemecahan Masalah Tugas Perangkat Daerah",
        levels: [
            "Tingkat I: Analisis kebijakan dan pemecahan masalah dilakukan secara sederhana dan dengan metode yang tidak terukur. [cite: 24]",
            "Tingkat II: Analisis kebijakan yang berdampak ke publik dilakukan oleh tim internal perangkat daerah yang bersangkutan. [cite: 25]",
    ...
    {
        id: 7,
        judul: "VII. Manajemen Sumber Daya yang Terukur",
        levels: [
            "Tingkat I: Penggunaan sumber daya dilakukan hanya berdasarkan ketentuan formal yang berlaku. [cite: 28]",
            "Tingkat II: Penentuan penggunaan input proyek dilakukan berdasarkan analisis kebutuhan bahan/ sumberdaya yang sudah ditetapkan. [cite: 28]",
    ...
    {
        id: 8,
        judul: "VIII. Manajemen Resiko Pelaksanaan Tugas Aparatur",
        levels: [
            "Tingkat I: Belum ada manajemen resiko dalam pelaksanaan tugas pada perangkat daerah. [cite: 30]",
            "Tingkat II: Sudah ada sebagian pegawai yang melakukan analisis resiko dalam pelaksanaan tugasnya, namun hanya bersifat individu. [cite: 30]",
    ...
    {
        id: 9,
        judul: "IX. Pengukuran Kinerja Perangkat Daerah dan Aparatur",
        levels: [
            "Tingkat I: Belum ada target/ rencana kinerja perangkat daerah yang terukur. [cite: 33]",
            "Tingkat II: Sudah ada target kinerja perangkat daerah, tapi belum konsisten mengacu dokumen perencanaan daerah. [cite: 33]",
    ...
    {
        id: 10,
        judul: "X. Pengembangan Inovasi Pelayanan Perangkat Daerah",
        levels: [
            "Tingkat I: Belum ada rencana pengembangan produk yang akan dilakukan secara sistematis. [cite: 36]",
            "Tingkat II: Pengembangan produk dilakukan dengan mengadopsi inovasi yang dikembangkan oleh daerah lain (replikasi inovasi). [cite: 36]",
    ...
    {
        id: 11,
        judul: "XI. Budaya Organisasi Perangkat Daerah",
        levels: [
            "Tingkat I: Belum ada budaya organisasi pada perangkat daerah. [cite: 37]",
            "Tingkat II: Sudah ada slogan-slogan yang menggambarkan nilai organisasi pada perangkat daerah yang bersangkutan. [cite: 37, 38]",
